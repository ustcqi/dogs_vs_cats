...
class FeatureExtractor:
    def __init__(self):
        ...
        self.features_h5y_root = '../data/features_h5y/'
...
def extract_feature(MODEL, image_size, lambda_func=None):
    width = image_size[0]
    height = image_size[1]
...
import models.xception as xception
extract_feature(xception.Xception, (299, 299), xception.preprocess_input)
